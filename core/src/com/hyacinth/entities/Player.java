...
public class Player extends DynamicEntity {
    ...
    public int update() {
        ...
        lArm.setTransform(pos.x - Constants.PLAYER_RADIUS - Constants.PLAYER_RADIUS/3 - 1, pos.y, 0);
        lArm.setLinearVelocity(this.getBody().getLinearVelocity().cpy());
        rArm.setTransform(pos.x + Constants.PLAYER_RADIUS + Constants.PLAYER_RADIUS/3 + 1, pos.y, 0);
        rArm.setLinearVelocity(this.getBody().getLinearVelocity().cpy());
